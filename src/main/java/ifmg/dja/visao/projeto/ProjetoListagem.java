 ...
 * @author Rodrigo
 */
public class ProjetoListagem extends javax.swing.JInternalFrame {

    /**
     * Creates new form ProjetoListagem
     */
    private final ProjetoRN pRN = new ProjetoRN();
    private List<Projeto> projetos;
    private ProjetoTableModelCompleta ptm;

    public ProjetoListagem() {
        initComponents();
        carregaTabela();
    ...
    private void carregaTabela() {
        ...
        projetos = pRN.buscarTodos();
        ptm = new ProjetoTableModelCompleta(projetos);
      ...
      //  jTable1.setDefaultRenderer(Object.class, new RenderizadorStripped());
        ...
        jTable1.getColumnModel().getColumn(4).setPreferredWidth(44);
        jTable1.getColumnModel().getColumn(5).setPreferredWidth(42);
    }
    ...
    private void jbtIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtIncluirActionPerformed
        ProjetoCadastro dialog = new ProjetoCadastro(null, true, pRN);
    ...
    private void jbtEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtEditarActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            ProjetoCadastro dialog = new ProjetoCadastro(null, true, pRN, ptm.getValueAt(jTable1.getSelectedRow()));
            dialog.setVisible(true);
            if (dialog.confirmou) {
                carregaTabela();
            }
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            if (resp != JOptionPane.YES_OPTION) {
                ...
                try {
                    pRN.excluir(ptm.getValueAt(jTable1.getSelectedRow()));
                    carregaTabela();
                } catch (Exception ex) {

                    JOptionPane.showMessageDialog(this, ex.getMessage());
                    Logger.getLogger(ProjetoTableModelCompleta.class.getName()).log(Level.SEVERE, null, ex);
                }
